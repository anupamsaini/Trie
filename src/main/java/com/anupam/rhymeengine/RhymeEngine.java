...
import com.anupam.rhymeengine.tries.LevenshteinDistance;
import com.anupam.rhymeengine.tries.StringBuilderWithRemove;
...
public class RhymeEngine {
   ...
   * @param node The node whose key would be searched for possible rhymeengine.
